...
import com.github.blovemaple.hura.dal.AbonkontoLogExample.Criteria;
import com.github.blovemaple.hura.dal.AbonkontoLogExample.Criterion;
import com.github.blovemaple.hura.dal.AbonkontoLogExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class AbonkontoLogSqlProvider {
	 ...
	 */
	public String countByExample(AbonkontoLogExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("abonkonto_log");
	 ...
	 * @mbg.generated  Sun Dec 23 22:48:53 CST 2018
	 */
	public String deleteByExample(AbonkontoLogExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("abonkonto_log");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Sun Dec 23 22:48:53 CST 2018
	 */
	public String insertSelective(AbonkontoLog record) {
		SQL sql = new SQL();
		sql.INSERT_INTO("abonkonto_log");
		...
		if (record.getRequest() != null) {
			sql.VALUES("request", "#{request,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbg.generated  Sun Dec 23 22:48:53 CST 2018
	 */
	public String selectByExample(AbonkontoLogExample example) {
		SQL sql = new SQL();
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		AbonkontoLog record = (AbonkontoLog) parameter.get("record");
		AbonkontoLogExample example = (AbonkontoLogExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("abonkonto_log");
		...
		if (record.getRequest() != null) {
			sql.SET("request = #{record.request,jdbcType=VARCHAR}");
		}
		if (record.getResponse() != null) {
			sql.SET("response = #{record.response,jdbcType=VARCHAR}");
		}
	 ...
	 * @mbg.generated  Sun Dec 23 22:48:53 CST 2018
	 */
	public String updateByPrimaryKeySelective(AbonkontoLog record) {
		SQL sql = new SQL();
		sql.UPDATE("abonkonto_log");
		if (record.getTime() != null) {
		...
		if (record.getRequest() != null) {
			sql.SET("request = #{request,jdbcType=VARCHAR}");
		}
		if (record.getResponse() != null) {
	 ...
	 * @mbg.generated  Sun Dec 23 22:48:53 CST 2018
	 */
	protected void applyWhere(SQL sql, AbonkontoLogExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
