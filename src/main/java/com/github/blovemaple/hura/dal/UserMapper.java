...
public interface UserMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, openid, unionid, nickName, avatarUrl, gender, country, province, city, language, addtime);
    ...
    default int insertSelective(User record) {
        return MyBatis3Utils.insert(this::insert, record, user, c ->
            c.map(openid).toPropertyWhenPresent("openid", record::getOpenid)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(User record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(openid).equalTo(record::getOpenid)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(User record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(openid).equalToWhenPresent(record::getOpenid)
